    ...
    <div className="min-h-screen bg-black pt-24 pb-20 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Start creating amazing videos today</p>
        </div>
        ...
        <div className="bg-gray-900 rounded-2xl p-8 border border-gray-800">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-start">
              <input type="checkbox" required className="rounded bg-gray-800 border-gray-700 text-purple-600 focus:ring-purple-500 mt-1" />
